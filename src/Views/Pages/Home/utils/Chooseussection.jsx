...
import six from "../../../../assets/sixth.svg";
      ...
      <div className="container mx-auto px-5 md:px-[160px] py-[70px]">
        <div className="text-start mb-8 pb-2 md:pb-12">
          ...
          <p className="pt-4 md:pt-0 text-sm 2xl:text-base font-roboto font-normal text-[#242424] opacity-70">
            ...
            professionals ranging from developers to consultants, project
            management companies, architects, and engineers; Spearheading
            diverse project teams and establishing design concepts, ranging in
            size from city-wide scale to small fractions of inches; Ensuring
            quality across delivered projects while maintaining budgetary
            alignment.
          </p>
        </div>
