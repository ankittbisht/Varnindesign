...
function Contactsection() {
  return (
    <>
      <div className="mx-auto px-4 md:px-20 lg:px-[160px] py-9 md:py-20 lg:py-[100px] overflow-hidden min-h-screen">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-8 ">
            ...
            <div className="pb-4  lg:pb-20">
              <h2
                ...
                className="text-4xl md:text-5xl lg:text-7xl font-normal  mb-6 font-body"
              >
                Contact Us
              </h2>
              <p
                data-aos="fade-down"
                data-aos-duration="1000"
                className="text-xs lg:text-sm text-gray-600 mb-4 font-roboto"
              >
            ...
            <div
              data-aos="zoom-in-up"
              data-aos-duration="1000"
              className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 w-[50%] md:w-full"
            >
              {/* Card 1 */}
              <div className="bg-white rounded-lg  text-start">
                <img src={call} alt="Logo 1" className="text-start h-11" />
                <h3 className="text-2xl lg:text-3xl font-normal font-body mb-2 mt-2">
                  Let's talk
                </h3>
              ...
              <div className="bg-white ">
                ...
                <h3 className="text-2xl lg:text-3xl   mb-2 font-normal font-body mt-2">
                  Support
                </h3>
                <p className="text-xs  font-normal font-roboto text-[#242424]">
                  info@kevin.com
            ...
            <button
              data-aos="zoom-in-up"
              data-aos-duration="1000"
              className="text-xs flex items-center gap-2 bg-[#0A23C7] text-white font-roboto py-2 px-4 rounded"
            >
              Send Message
              <svg
                width="18"
          ...
          >
            ...
            <img
              src={bgImg}
              alt="Image 2"
              className="hidden lg:block h-[400px] md:h-[270px] xl:h-[300px]  top-[-470px] md:top-[15px] xl:top-[-15px] left-[254px] lg:left-[95%] xl:left-[70%] w-[140px] xl:w-[190px] absolute z-0"
            />
            <img
              src={bnrImg}
              alt="Image 1"
              className="top-[-455px]  md:top-[35px] xl:top-0 right-0 md:left-0 lg:left-[100px] xl:left-[60px] h-[440px] md:h-[80%] lg:h-[427px] w-2/4 md:w-full mb-4 absolute z-10"
            />
          </div>
        </div>
      </div>
